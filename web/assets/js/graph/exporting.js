...
(function (f) {
	...
	k(f, "mixins/navigation.js", [], function () {
		return {
			initUpdate: function (g) {
				g.navigation || (g.navigation = {
					updates: [],
					update: function (g, f) {
						this.updates.forEach(function (e) {
							e.update.call(e.context, g,
								f)
						})
					}
				})
			},
			addUpdate: function (g, e) {
	...
	k(f, "modules/exporting.src.js", [f["parts/Globals.js"], f["parts/Utilities.js"], f["mixins/navigation.js"]], function (g, e, f) {
		...
		t(A.prototype, {
			...
			getSVG: function (a) {
				...
				q = c.exporting.sourceHeight || c.chart.height || /px$/.test(q) && parseInt(q, 10) || 400;
				t(c.chart, {
					animation: !1,
					renderTo: d,
					forExport: !0,
				...
				var f = new g.Chart(c, this.callback);
				a && ["xAxis", "yAxis", "series"].forEach(function (b) {
					var d = {};
					a[b] && (d[b] = a[b], f.update(d))
				});
				this.axes.forEach(function (b) {
					var a = g.find(f.axes, function (a) {
							return a.options.internalKey ===
								b.userOptions.internalKey
						}),
						d = b.getExtremes(),
						c = d.userMin;
					d = d.userMax;
					a && (void 0 !== c && c !== a.min || void 0 !== d && d !== a.max) && a.setExtremes(c, d, !0, !1)
				});
				e = f.getChartHTML();
				B(this, "getSVG", {
					chartCopy: f
				});
				e = this.sanitizeSVG(e, c);
				c = null;
				f.destroy();
				k(d);
				return e
			...
			print: function () {
				...
				if (!b.isPrinting) {
					...
					if (f = g && b.chartWidth > g) {
						...
						1 === a.nodeType && (c[b] = a.style.display, a.style.display =
							"none")
					});
					a(d);
					setTimeout(function () {
			...
			contextMenu: function (a, b, c, d, e, f, E) {
				var h = this,
				...
				if (!l) {
					...
					b.forEach(function (a) {
						...
						if (I(a, !0)) {
							if (a.separator) var b = v("hr", null, null, k);
							else b = v("div", {
				...
				if (!1 !== d.enabled) {
					...
					e ? z = function (a) {
						...
						b.contextMenu(m.menuClassName, g, m.translateX,
							m.translateY, m.width, m.height, m);
						m.setState(2)
					});
		...
		A.prototype.inlineStyles = function () {
			...
			function b(c) {
				function m(b, f) {
					...
					for (q = e.length; q-- && !u;) u = e[q].test(f) ||
						"function" === typeof b;
